...
export function Details({ summary, children }: DetailsProps) {
  return (
    <details className='group my-4 bg-[var(--color-window-bg)] border-2 border-white border-r-[var(--color-border-dark)] border-b-[var(--color-border-dark)] p-1'>
      <summary className='cursor-pointer font-bold text-sm bg-[var(--color-window-bg)] text-black list-none flex items-center gap-2 p-1 hover:bg-[var(--color-window-title-active)] hover:text-white group-open:mb-1 select-none focus:outline-none focus:ring-1 focus:ring-black focus:ring-dotted'>
